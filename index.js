  ...
  try {
    ...
    if (
      ...
      if (category === 'addendum') {
        ...
        console.log(
          'Fetching approved trades for addendum dropdown...'
        );
        ...
        try {
          ...
          console.error(
            'Failed to parse approved trades:',
            rawText
          );
        }
    ...
    if (
      ...
      console.log(
        'New trade submission, forwarding to Make.com...'
      );
    ...
    if (
      ...
      console.log(
        'Addendum submission, forwarding to Make.com...'
      );
      ...
      const responseData = {
        ...
        data: {
          is_success: true,
          message:
            'Your addendum has been submitted successfully.'
        }
      };
