    ...
    if (screen === 'Trade_Details') {
      ...
      if (trade_type === 'new_trade') {
        return send(res, aesKey, flippedIv, {
          ...
          data: { commodity: commodityTitle, direction_options: DIRECTION_OPTIONS }
        });
      }
      ...
      if (['linked_trade', 'addendum', 'modification', 'cloned_trade', 'back_to_back'].includes(trade_type)) {
        // Direction is not chosen on Trade_Details anymore; get_active uses empty direction.
        ...
        if (trade_type === 'linked_trade') {
          ...
          dataPayload = { commodity: commodityTitle, active_trades: trades, direction_options: DIRECTION_OPTIONS };
